...
layers = [
    ...
    convolution2dLayer([3 3],384,"Name","S2_conv3","BiasLearnRateFactor",2,"Padding",[1 1 1 1],"Bias",params.conv3.Bias,"Weights",params.conv3.Weights)
    reluLayer("Name","S2_relu3")
    groupedConvolution2dLayer([3 3],192,2,"Name","S2_conv4","BiasLearnRateFactor",2,"Padding",[1 1 1 1],"Bias",params.conv4.Bias,"Weights",params.conv4.Weights)
    reluLayer("Name","S2_relu4")
    groupedConvolution2dLayer([3 3],128,2,"Name","S2_conv5","BiasLearnRateFactor",2,"Padding",[1 1 1 1],"Bias",params.conv5.Bias,"Weights",params.conv5.Weights)
    reluLayer("Name","S2_relu5")
    maxPooling2dLayer([3 3],"Name","S2_pool5","Stride",[2 2])
    fullyConnectedLayer(4096,"Name","S2_fc6","BiasLearnRateFactor",2,"Bias",params.fc6.Bias,"Weights",params.fc6.Weights)
    reluLayer("Name","S2_relu6")
    dropoutLayer(0.5,"Name","S2_drop6")
    fullyConnectedLayer(4096,"Name","S2_fc7","BiasLearnRateFactor",2,"Bias",params.fc7.Bias,"Weights",params.fc7.Weights)
    reluLayer("Name","S2_relu7")
    dropoutLayer(0.5,"Name","S2_drop7")
    fullyConnectedLayer(1000,"Name","S2_fc8","BiasLearnRateFactor",2,"Bias",params.fc8.Bias,"Weights",params.fc8.Weights)
    softmaxLayer("Name","S2_prob")
    classificationLayer("Name","S2_output","Classes",params.output.Classes)];
